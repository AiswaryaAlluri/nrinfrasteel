    ...
    <footer className="bg-[#1a1a1a] text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Leading manufacturer and supplier of high-quality steel scaffolding and centering materials in Hyderabad.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <a href="tel:9697786999" className="flex items-center space-x-2 hover:text-orange-500 transition-colors">
                <Phone size={16} />
                <span>9697 786 999</span>
              </a>
              <a href="tel:9912822924" className="flex items-center space-x-2 hover:text-orange-500 transition-colors">
                <Phone size={16} />
        ...
        <div className="border-t border-gray-800 pt-6 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} NR Infra Steel. All rights reserved.</p>
